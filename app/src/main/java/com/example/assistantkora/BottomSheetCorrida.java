...
public class BottomSheetCorrida extends Dialog {

    private int iduser = 0;
    private Context mContext;

    public BottomSheetCorrida(@NonNull Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bottom_sheet_corrida);
    ...
    private class PostDataTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                URL url = new URL("http://kora.us.to/file/saude/corrida.php"); // Substitua pela URL do seu script PHP
