...
public class BottomSheetCaminhada extends Dialog {

    private int iduser = 0;
    private Context mContext;

    public BottomSheetCaminhada(@NonNull Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bottom_sheet_caminhada);
    ...
    private class PostDataTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                URL url = new URL("http://kora.us.to/file/saude/caminhada.php"); // Substitua pela URL do seu script PHP
